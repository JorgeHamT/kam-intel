  ...
  [962],
  {
    ...
    6874: (e, t, n) => {
      ...
      function g(e) {
        ...
        let R = u.default.useContext(a.AppRouterContext),
          k = !1 !== O,
          w = null === O ? l.PrefetchKind.AUTO : l.PrefetchKind.FULL,
          { href: D, as: F } = u.default.useMemo(() => {
            let e = y(P);
            return { href: e, as: _ ? y(_) : e };
          }, [P, _]);
        A && (n = u.default.Children.only(t));
        let K = A ? n && "object" == typeof n && n.ref : M,
          B = u.default.useCallback(
            (e) => (
              null !== R &&
                (m.current = (0, p.mountLinkInstance)(e, D, R, w, k, g)),
              () => {
                m.current &&
                  ((0, p.unmountLinkForCurrentNavigation)(m.current),
                  (m.current = null)),
          ...
          z = {
            ...
            onMouseEnter(e) {
              A || "function" != typeof N || N(e),
                ...
                R && k && (0, p.onNavigationIntent)(e.currentTarget, !0 === I);
            },
