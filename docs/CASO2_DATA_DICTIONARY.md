...
- `invalid_number`: reservado para strings numéricos no interpretables.
...
- `delta_rating_mismatch`: diferencia entre original y recálculo oficial.
- `var_ordenes_pct_mismatch`: diferencia entre original y recálculo oficial.
